  ...
  return (
    ...
    >
      <div className={styles.carouselContainer}>
        <img src="https://react-shop-oinochoe.vercel.app/img_shop_fashion.jpeg" alt="banner1" />
      ...
      <div className={styles.carouselContainer}>
        <img src="https://react-shop-oinochoe.vercel.app/img_shop_digital.jpeg" alt="banner2" />
        <div className={styles.des}>
      ...
      <div className={styles.carouselContainer}>
        <img src="	https://react-shop-oinochoe.vercel.app/img_shop_grocery.jpeg" alt="banner3" />
        <div className={styles.des}>
